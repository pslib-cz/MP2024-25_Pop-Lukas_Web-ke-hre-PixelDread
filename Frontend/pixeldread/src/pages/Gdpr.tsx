...
const GDPR = () => {
    return (
        <main>
            ...
            <p>
                We use cookies to improve your browsing experience. By using our website, you consent to the use of cookies in accordance with our <Link to="/cookies">cookie policy</Link>.
            </p>
